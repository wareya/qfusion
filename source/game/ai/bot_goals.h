...
{
public:
	BotGrabItemGoal( Ai *ai_ ) : BotBaseGoal( ai_, "BotGrabItemGoal", COLOR_RGB( 0, 255, 0 ), 750 ) {}
...
{
public:
	BotKillEnemyGoal( Ai *ai_ ) : BotBaseGoal( ai_, "BotKillEnemyGoal", COLOR_RGB( 255, 0, 0 ), 750 ) {}
...
{
public:
	BotRunAwayGoal( Ai *ai_ ) : BotBaseGoal( ai_, "BotRunAwayGoal", COLOR_RGB( 0, 0, 255 ), 750 ) {}
...
public:
	BotAttackOutOfDespairGoal( Ai *ai_ )
		: BotBaseGoal( ai_, "BotAttackOutOfDespairGoal", COLOR_RGB( 192, 192, 0 ), 500 ),
...
{
public:
	BotReactToEnemyLostGoal( Ai *ai_ ) : BotBaseGoal( ai_, "BotReactToEnemyLostGoal", COLOR_RGB( 0, 192, 192 ), 750 ) {}
